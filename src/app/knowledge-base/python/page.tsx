    ...
    <>
      ...
      <div className="min-h-screen flex items-center justify-center pt-16">
        <div className="text-center">
          <div className="font-mono text-xs mb-4" style={{ color: 'var(--teal)' }}>PYTHON · COMING SOON</div>
          <h1 className="font-display text-4xl font-semibold mb-4" style={{ color: 'var(--ink)' }}>Python for Actuaries</h1>
